...
describe('reactA11yImgHasAlt', function () {
    ...
    describe('default tests', function () {
        describe('should pass', function () {
            ...
            it('when the img element has non-empty alt value and undefined presentation role', function () {
                var fileName = fileDirectory + 'ImgElementHasNonEmptyAltValueAndUndefinedPresentationRole.tsx';
                TestHelper_1.TestHelper.assertNoViolation(ruleName, fileName);
            });
